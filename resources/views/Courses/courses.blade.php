...
<body>
    <div class="flex justify-center lg:justify-between items-start">
        ...
        <div class="w-full flex flex-col items-center justify-start mt-56 px-10 ">
            <div class="w-full flex justify-center mb-28">
                <h1 class="text-5xl font-semibold">All courses</h1>
            </div>
            <div class="block w-full flex justify-end mb-10 absolute top-80 right-10 lg:hidden">
                            ...
                            <div class="flex justify-between items-center mt-2">
                                ...
                                <div class="flex items-center">
                                    <form action="{{ route('cart.add', $item->id) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="text-xl mr-5 text-purple-600 py-2 px-3 bg-purple-200 rounded-md hover:bg-purple-600 hover:text-white duration-200 ease-in-out"><i class="fa-solid fa-cart-plus"></i></button>
                                    </form>
...
<div class="flex justify-center lg:justify-between items-start ">
    ...
    <div class="w-10/12 flex flex-col items-center justify-start mt-56">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-x-7 gap-y-10 px-5">
            @foreach ($courses as $item)
