...
@section('formateurTiltle', 'Notifications')
...
<a href="{{ route('notifications') }}" class="flex items-center text-lg mt-5 py-2.5 px-4 rounded transition duration-200 text-gray-600 hover:bg-purple-600 hover:text-white" id="notifications-link">
    ...
    Notifications
    <span id="notifications-count" class="ml-2 bg-red-500 text-white text-sm font-semibold px-2.5 py-0.5 rounded-full {{ (!isset($newNotificationsCount) || $newNotificationsCount == 0) ? 'hidden' : '' }}">
